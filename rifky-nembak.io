            ...
            <div class="modal" id="modal-one" arial-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-header">
                        ...
                        <p>Untuk Bapao: Gua suka sama lu sudah lama , cuman baru hari ini
                            gua bisa mengutarakan isi hati gua, Watashi wa anata ga sukidesu.
                    ...
                    <div class="modal-footer">
                        <a href="https://wa.me/6289686272363x?text=Saya menerima nya" class="btn">Kirim Jawaban</a> <!--ganti ke close-->
         ...
         <div class="modal2" id="modal-one2" arial-hidden="true">
            <div class="modal-dialog2">
                ...
                <div class="modal-footer2">
                    <a href="https://wa.me/6281310692786?xtext=saya tidak menerima, dengan alasan" class="btn2">Kirim Jawaban</a> <!--ganti ke close-->
                </div>
                </div>
            </div>
        </div>
